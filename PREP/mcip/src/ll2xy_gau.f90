...
SUBROUTINE ll2xy_gau (phi, lambda, lambda0, xx, yy)

!-------------------------------------------------------------------------------
! Name:     Latitude-Longitude to (X,Y) for Gaussian Projection
! Purpose:  Calcluates (X,Y) from origin for a given latitude-longitude pair
!           and Gaussian projection information.
! Notes:    Equations taken from "Map Projections: Theory and Applications"
!           by Frederick Pearson, II (1990), pp. 190-192.
! Revised:  18 Nov 2019  Original version.  (P.C. Campbell)
!-------------------------------------------------------------------------------
